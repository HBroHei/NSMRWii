...
def read(config_f, stage_f: str):
    global log, enemyList, enemyVarList, reduceLag, randomiseEntrance, skipLvl, lvlGroup, tileGroup, tiles0List, secret_exit
    stageList = listdir(stage_f)
    ...
    shutil.copytree(stage_f,STG_TEMP)
